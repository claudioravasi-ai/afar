...
function sembrarDemo(forzar){
  ...
  escribir('fichas', 'fic_demo1', {
    ...
    diagnostico:'Colelitiasis con colecistitis aguda',
    lateralidad:'No aplica', cirujano:'Dr. Martín Gutiérrez', ayudante:'Dra. Paula Vega',
    instrumentador:'Inst. Carla Ruiz', estado:'cerrada',
    v:{
      antecedentes2:[{n:'Hipertensión arterial',sis:'Cardiovascular'},
             {n:'Diabetes tipo 2',sis:'Endocrino-metabólico'},
             {n:'Obesidad',sis:'Endocrino-metabólico'},
             {n:'Reflujo gastroesofágico',sis:'Digestivo-hepático'}],
      antecedentes:{
  ...
  escribir('fichas', 'fic_demo2', {
    ...
    diagnostico:'Fractura pertrocantérea',
    lateralidad:'Derecha', cirujano:'Dr. Hernán Ledesma', ayudante:'Dr. Nicolás Sosa',
    estado:'cerrada',
    v:{
      antecedentes2:[{n:'Fibrilación auricular',sis:'Cardiovascular'},
             {n:'Cardiopatía isquémica / IAM previo',sis:'Cardiovascular'},
             {n:'Insuficiencia cardíaca',sis:'Cardiovascular'},
             {n:'Insuficiencia renal crónica',sis:'Renal-urológico'},
             {n:'Portador de marcapasos / CDI',sis:'Cardiovascular'}],
      antecedentes:{
  ...
  escribir('fichas', 'fic_demo4', {
    ...
    v:{ antecedentes2:[{n:'Hipertensión arterial',sis:'Cardiovascular'},{n:'Diabetes tipo 2',sis:'Endocrino-metabólico'}],
  ...
  escribir('fichas', 'fic_demo5', {
    ...
    diagnostico:'Anemia no especificada',
    cirujano:'Dr. Alejandro Bravo', estado:'borrador',
    v:{
      antecedentes2:[{n:'Anemia',sis:'Hematológico'},
             {n:'Fibrilación auricular',sis:'Cardiovascular'},
             {n:'Anticoagulación crónica',sis:'Hematológico'}],
  ...
  escribir('fichas', 'fic_demo6', {
    ...
    diagnostico:'Fibrilación auricular paroxística',
    cirujano:'Dr. Sebastián Ocampo', estado:'cerrada',
    v:{ antecedentes2:[{n:'Fibrilación auricular',sis:'Cardiovascular'},
               {n:'Insuficiencia cardíaca',sis:'Cardiovascular'}],
